...
function render()
{
    ...
    var rotation = matricesRotation(theta);
    var scalings = [
        scale( 0.4, 0.4, 0.4 ),     scale( 0.7, 0.2, 0.2 ),     scale( 0.4, 0.4, 0.4 ),
        scale( 0.2, 0.2, 0.7 ),    scale( 0.2, 0.2, 0.7 ),
        scale(  0.4, 0.4, 0.4 ),    scale( 0.7, 0.2, 0.2 ),    scale(  0.4, 0.4, 0.4 )
    ];
    var translates = [
        translate(-0.5, 0, -0.5),   translate(0, 0, -0.5),  translate(0.5,0,-0.5),
        translate(-0.5, 0, 0),      translate(.5, 0, 0),
        translate(-0.5, 0, .5),     translate(0, 0, .5),    translate(.5, 0, .5)
    ];
